...
namespace LLENON\OltInformation\OLT\VSOL\EPON\Support;
...
final class MacAddress
{
    ...
    public static function forOnuLookup(string $macAddress): string
    {
