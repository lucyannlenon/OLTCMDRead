...
use LLENON\OltInformation\OLT\DATACOM\Command\DataProcessors\GetVlanStringParser;
use LLENON\OltInformation\OLT\Utils\Command\AbstractCommand;

class GetVlanCommand extends AbstractCommand
{
    ...
    {
        $parser = new GetVlanStringParser();
